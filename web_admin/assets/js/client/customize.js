jQuery(function($){
    ...
    var time = d.toLocaleTimeString();	
			...
			socket.on('whisper', function(data){
				 var d = new Date();
    var time = d.toLocaleTimeString();
				$chat.append('<div class="ui-grid-solo margin-solo"><img src="http://gokadabra.topuserapps.com/upload/client/images/icon-dp.png" class="float-p" width="42" height="47" alt=""><div class="bubble-out"><b>' + data.nick + ': </b>' + data.msg + '<div class="align-r"><span>' + time + '</span>&nbsp;<i class="fa fa-thumbs-up"></i></div></div>');
